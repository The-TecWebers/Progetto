...
$parameters = [
    ...
    'Riparazione perdita acquedotto Artogne', $id_user, '2016-04-27', 'Artogne, Via Fornaci', 'uploads/riparazione_perdita_acquedotto_artogne/acquedotto_Artogne_via_fornaci_2016.webp', 'Richiesta di pronto intervento per la riparazione di una perdita nell’acquedotto in via Fornaci, Artogne. Necessario intervento immediato per evitare disagi ai residenti',
    ...
    'Emergenza fuga di gas Bienno', $id_user, '2023-01-12', 'Bienno', 'uploads/emergenza_fuga_di_gas_bienno/fuga_gas_bienno.webp', 'Richiesta di pronto intervento per fuga di gas in località Bienno. Operazione urgente con personale specializzato e attrezzature adeguate per garantire la sicurezza',
    ...
    'Pronto intervento fuga gas Piancamuno', $id_user, '2023-10-30', 'Piancamuno, pista ciclabile', 'uploads/pronto_intervento_fuga_gas_piancamuno/Pronto_Intervento_pista_ciclabile.webp', 'Richiesta di pronto intervento per una fuga di gas lungo la pista ciclabile di Piancamuno. Operazione urgente con personale e attrezzatura specifica per la messa in sicurezza',
    ...
    'Manutenzione stradale neve Artogne', $id_user, '2023-12-12', 'Artogne e frazioni', 'uploads/manutenzione_stradale_neve_artogne/Neve_salatura.webp', 'Richiesta di intervento per la manutenzione stradale a seguito di nevicate abbondanti nel Comune di Artogne e frazioni. Operazione di salatura e sgombero neve per garantire la viabilità sicura',
    ...
    'Saldatura acquedotto Civo', $id_user, '2023-04-15', 'Civo', 'uploads/saldatura_acquedotto_civo/saldatura_acquedotto_civo.webp', 'Richiesta di saldatura dell’acquedotto in località Civo. Operazione necessaria per la derivazione di acqua a uso idroelettrico dal torrente Cavrucco, nei comuni di Civo e Valmasino',
