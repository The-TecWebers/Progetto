...
$parameters = [
    'Saldatura Acquedotto Schiesone', $id_publicocomune, '2023-03-08', 'Prata Camportaccio', 'uploads/saldatura_acquedotto_schiesone/saldatura_acquedotto.webp', 'Valvola a farfalla flangiata in ghisa con attuatore manuale e riduttore a vite senza fine', 'Richiesta di intervento per la saldatura dell’acquedotto nel territorio di Prata Camportaccio. Operazione necessaria per completare il sistema di derivazione idroelettrica del torrente Schiesone',
    ...
    'Smantellamento antenna Mediaset', $id_publicocomune, '2014-05-20', 'Albere, Piazze, Artogne', 'uploads/smantellamento_antenna_mediaset/Smantellamento_Antenna_2014.webp', 'Torre di telecomunicazioni in acciaio con ripetitori e traliccio su una collina', 'Richiesta preventivo per lo smantellamento di una vecchia antenna Mediaset in località Albere, Piazze, e la costruzione di un nuovo basamento per la futura installazione',
    ...
    'Manutenzione cabina metano Cividate', $id_metanometani, '2023-08-20', 'Cividate', 'uploads/manutenzione_cabina_metano_cividate/Metano_Cabina_cividate.webp', 'Tubi colorati, valvole e manometri in una centrale di pompaggio industriale', 'Richiesta di intervento per la manutenzione della cabina metano in località Cividate. Operazione necessaria per la saldatura di tubature e isolamento con Stop System, garantendo la sicurezza del sistema',
